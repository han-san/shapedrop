...
public:
    ...
    [[nodiscard]] auto static from_height(std::string_view string, double desiredPixelHeight) -> FontString;
    [[nodiscard]] auto static from_height_normalized(std::string_view string, double desiredHeight) -> FontString;
